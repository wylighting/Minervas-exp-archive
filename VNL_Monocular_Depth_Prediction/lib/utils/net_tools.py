...
def load_ckpt(args, model, optimizer=None, scheduler=None, val_err=[]):
    ...
    if os.path.isfile(args.load_ckpt):
        ...
        print('Error! {} is not exist.'.format(args.load_ckpt))


def save_ckpt(args, step, epoch, model, optimizer, scheduler, val_err={}, is_best=False):
    """Save checkpoint"""
    ...
    if is_best:
        save_name = os.path.join(ckpt_dir, 'best_valid.pth')
