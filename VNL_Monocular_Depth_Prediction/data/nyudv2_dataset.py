...
class NYUDV2Dataset():
    def initialize(self, opt):
        ...
        self.depth_normalize = 10000.0 # our synthic data has the same range with real data.
    ...
    def getData(self):
        ...
        if 'dir_AB' in AB_anno[0].keys():
            ...
            # load mat
            # AB = mat73.loadmat(self.dir_AB)
            print('Loading dataset {}'.format(self.dir_AB))
            try:
            ...
            print('Loading dataset {}'.format(self.opt.dataroot), 'depth_normalize:', self.depth_normalize)
            self.A = None
            self.B = None
